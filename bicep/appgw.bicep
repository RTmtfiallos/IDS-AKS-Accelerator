...
▌│█║▌║▌║ Matthew Fiallos, K8s Lead Architect - matthew.fiallos@randstadusa.com ║▌║▌║█│▌
...
// Create a variable with the app gateway properties, because of the conditional key 'autoscaleConfiguration'
